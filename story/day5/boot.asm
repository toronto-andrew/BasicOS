...
list_files:
    ; 文件
dump_dir_start:         ; 读取位置
    mov al, [root_dir_sector]  ; 使用root_dir_sector而不是重新定义它
...
option1_msg db '1. list_files', 0x0D, 0x0A, 0
option2_msg db '2. read_file', 0x0D, 0x0A, 0
option3_msg db '3. exit_program', 0x0D, 0x0A, 0
exit_msg db 'Exiting program...', 0x0D, 0x0A, 0
root_dir_sector db 0   ; 只在这里定义一次